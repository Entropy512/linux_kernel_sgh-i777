/* Cypress Antioch HAL for QC KERNEL header file (cyashalqckernel.h)
## ===========================
 ...
 * layer on QC talking to the West Bridge Astoria device
 */


#ifndef _INCLUDED_CYASHALQC_KERNEL_H_
#define _INCLUDED_CYASHALQC_KERNEL_H_
