...
typedef struct cy_as_gadget_ioctl_just_ret {
	uint32_t ret_val;
} cy_as_gadget_ioctl_just_ret;
...
#define CYASGADGET_CANCELSOJ \
	_IOW(CYASGADGET_IOC_MAGIC,   4, cy_as_gadget_ioctl_just_ret)
#define CYASGADGET_CANCELGOJ \
	_IOW(CYASGADGET_IOC_MAGIC,   5, cy_as_gadget_ioctl_just_ret)
#define CYASGADGET_STOR_RELEASE \
	_IOW(CYASGADGET_IOC_MAGIC,   6, cy_as_gadget_ioctl_just_ret)
#define CYASGADGET_STOR_CLAIM \
	_IOW(CYASGADGET_IOC_MAGIC,   7, cy_as_gadget_ioctl_just_ret)
#define CYASGADGET_IOC_MAXNR 8
