...
#define Si4709_IOC_CUR_RSSI_GET				_IOR(Si4709_IOC_MAGIC, 12, \
	rssi_snr_t)
...
#define Si4709_IOC_RSTATE_GET				_IOR(Si4709_IOC_MAGIC, 21, \
	dev_state_t)

#define Si4709_IOC_RDS_DATA_GET				_IOR(Si4709_IOC_MAGIC, 22, \
	radio_data_t)
...
/*VNVS:START 13-OCT'09 :
 Added IOCTLs for reading the device-id,chip-id,power configuration, system configuration2 registers*/
#define Si4709_IOC_DEVICE_ID_GET			_IOR(Si4709_IOC_MAGIC, 27, \
	device_id)

#define Si4709_IOC_CHIP_ID_GET				_IOR(Si4709_IOC_MAGIC, 28, \
	chip_id)

#define Si4709_IOC_SYS_CONFIG2_GET			_IOR(Si4709_IOC_MAGIC, 29, \
	sys_config2)

#define Si4709_IOC_POWER_CONFIG_GET			_IOR(Si4709_IOC_MAGIC, 30, \
	power_config)
...
#define Si4709_IOC_SYS_CONFIG3_GET			_IOR(Si4709_IOC_MAGIC, 33, \
	sys_config3)

#define Si4709_IOC_STATUS_RSSI_GET			_IOR(Si4709_IOC_MAGIC, 34, \
	status_rssi)

#define Si4709_IOC_SYS_CONFIG2_SET			_IOW(Si4709_IOC_MAGIC, 35, \
	sys_config2)

#define Si4709_IOC_SYS_CONFIG3_SET			_IOW(Si4709_IOC_MAGIC, 36, \
	sys_config3)
