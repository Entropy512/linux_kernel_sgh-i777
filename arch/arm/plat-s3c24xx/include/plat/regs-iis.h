...
#ifdef CONFIG_CPU_S3C2416
#define S3C2410_IISMOD_RXMODE  (0<<6)
#define S3C2410_IISMOD_TXMODE  (1<<6)
#define S3C2410_IISMOD_TXRXMODE	(0x2<<8)
#define S3C2410_IISMOD_8BIT	(0x1<<13)
#define S3C2410_IISMOD_16BIT	(0x0<<13)
...
#define S3C2410_IISMOD_TXRXMODE	(2<<6)
...
#define S3C2410_IISFCON_TXDMA	(0<<15)
#else
